    ...
    <footer className="bg-charcoal text-cream mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="font-display font-bold text-xl mb-4 text-gold">Sobre Nós</h3>
            <p className="text-cream/80 font-sans text-sm leading-relaxed">
              A Livraria Elegante é sua fonte de grandes histórias e conhecimento. 
              Oferecemos uma seleção cuidadosa de livros para todos os gostos.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="font-display font-bold text-xl mb-4 text-gold">Links Rápidos</h3>
            <ul className="space-y-2 font-sans text-sm">
              ...
              <li>
                <a href="/cart" className="text-cream/80 hover:text-gold transition-colors">
                  Carrinho
                </a>
              </li>
              <li>
                <a href="/orders" className="text-cream/80 hover:text-gold transition-colors">
                  Pedidos
                </a>
              </li>
            </ul>
          ...
          {/* Categories */}
          <div>
            <h3 className="font-display font-bold text-xl mb-4 text-gold">Categorias</h3>
            <ul className="space-y-2 font-sans text-sm">
          ...
          {/* Contact */}
          <div>
            <h3 className="font-display font-bold text-xl mb-4 text-gold">Contato</h3>
