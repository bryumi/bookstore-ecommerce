  ...
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        <button
          onClick={onBack}
          className="flex items-center gap-1.5 font-sans text-[10px] uppercase tracking-[0.2em] text-charcoal/30 hover:text-charcoal mb-10 transition-colors"
        >
          ← Voltar
        </button>
        ...
        <p className="font-body text-sm italic text-charcoal/40 mb-8">
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="font-sans text-[9px] uppercase tracking-[0.2em] text-charcoal/20">
            ou
          </span>
          <div className="flex-1 h-px bg-charcoal/8" />
        </div>
